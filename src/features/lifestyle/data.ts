...
export const HOUSING_OPTIONS: LifestyleOption<HousingTier>[] = [
  ...
  {
    id: 'shared-plus',
    title: 'Quiet Flatshare',
    monthlyCost: 305,
    switchCost: 210,
    description: 'Still shared, but calmer, cleaner, and much easier to build a routine around.',
    ...image('https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=1200&q=80', 'Warm shared apartment living room with clean natural light'),
  },
  {
    id: 'studio',
    title: 'Tiny Studio',
...
export const TRANSPORT_OPTIONS: LifestyleOption<TransportTier>[] = [
  ...
  },
  {
    ...
    monthlyCost: 38,
    switchCost: 40,
    description: 'Still budget travel, but a lot less fragile than hoping every walk and transfer lines up.',
    ...image('https://images.unsplash.com/photo-1517142089942-ba376ce32a2e?auto=format&fit=crop&w=1200&q=80', 'City train arriving at a clean underground platform'),
  },
  {
    id: 'bike',
    title: 'Used Bike',
...
export const FOOD_OPTIONS: LifestyleOption<FoodTier>[] = [
  ...
  },
  {
    ...
    monthlyCost: 205,
    switchCost: 45,
    description: 'Still cheap, but a little planning keeps your energy steadier through the week.',
    ...image('https://images.unsplash.com/photo-1490645935967-10de6ba17061?auto=format&fit=crop&w=1200&q=80', 'Simple prepared meals lined up in containers on a kitchen counter'),
  },
  {
    id: 'balanced',
...
export const WELLNESS_OPTIONS: LifestyleOption<WellnessTier>[] = [
  ...
  },
  {
    ...
    monthlyCost: 72,
    switchCost: 35,
    description: 'A small monthly cost for a better routine, better recovery, and a cleaner step up from just scraping by.',
    ...image('https://images.unsplash.com/photo-1540497077202-7c8a3999166f?auto=format&fit=crop&w=1200&q=80', 'Community gym with simple cardio and weights'),
  },
  {
    id: 'gym',
